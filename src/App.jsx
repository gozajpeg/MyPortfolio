...
function App() {
  ...
  const navLinkClass = ({ isActive }) => 
    `px-8 py-4 text-sm tracking-[0.15em] uppercase cursor-pointer outline-none border-none block text-left bg-gradient-to-r from-[#ededed] from-50% to-transparent to-50% bg-[length:200%_100%] transition-all duration-500 ease-out ${
      isActive 
  ...
  return (
    <Router>
      ...
      <aside className="w-full md:w-[45%] lg:w-1/3 p-8 md:p-16 flex flex-col justify-center border-b md:border-b-0 md:border-r border-[#222222] md:h-full md:overflow-y-auto no-scrollbar">
        <div className="flex items-center gap-4 md:gap-6 mb-2">
          <img src={gozagrayImg} alt="Logo" className="w-12 h-12 md:w-16 md:h-16 shrink-0 object-contain" />
          <h1 className="text-[clamp(2rem,4vw,3rem)] font-extralight tracking-[-0.02em] text-left leading-tight">
            Rommel Angelo T. Goza
          </h1>
        </div>
        <p className="text-sm font-normal tracking-[0.3em] uppercase text-[#737373] mb-16 text-left">
          Portfolio
        </p>
      ...
      <main className="w-full md:w-[55%] lg:w-2/3 p-8 md:p-16 flex flex-col md:h-full md:overflow-y-auto no-scrollbar">
        <Routes>
          <Route path="/" element={
